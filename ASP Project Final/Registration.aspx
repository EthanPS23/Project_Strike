<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="ASP_Project_Final.Registration" %>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form class="form-group" id="form1" runat="server">
                    ...
                    <asp:TextBox CssClass="form-control" TextMode="Password" ID="txtPassword" runat="server" OnTextChanged="txtPassword_TextChanged"></asp:TextBox>
                    <br />
                    <asp:Label CssClass="regFields" ID="lblRetypePassword" runat="server" Text="Retype Password"></asp:Label>
                    <asp:TextBox CssClass="form-control" TextMode="Password" ID="txtRetypePassword" runat="server" OnTextChanged="txtPassword_TextChanged"></asp:TextBox>
                    <br />
                    ...
                    <br />
                    <p class="text-center"> 
                        <asp:Button CssClass="btn btn-outline-primary" ID="btnRegister" runat="server" Text="Register" OnClick="btnRegister_Click" />
